 ...
 * 
 * @property {string[]} buildTasks
 * List of tasks to build the application
 * 
 * @property {string[]} devTasks
 * List of tasks for developpers
 */
export const reactApp = (
  ...
  return {
    buildTasks: addedTasks.filter(taskName => !taskName.endsWith(":dev")),
    devTasks: addedTasks.filter(taskName => taskName.endsWith(":dev")),
  };
};
