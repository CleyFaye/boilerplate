 ...
 * List of entrypoints.
 * Defaults to {targetName: "webres/js/targetName.js"}
 * 
 * @param {Object} [webpackOptions.output]
 * Configure webpack output location and name.
 * Defaults to {path: "dist/<targetName>", filename: "[name].js"}
 * 
...
export default (gruntConfig, targetName, webpackOptions) => {
  ...
  const webpackConfig = {
    ...
    devServer: {
      contentPath: webpackOptions.contentPath,
